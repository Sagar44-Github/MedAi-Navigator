...
`
  ...
  <change>
    <file>src/services/medical-facility-locator.ts</file>
    <description>Updated comments to reflect medical facility search by location and specialty</description>
    <content><![CDATA[/**
